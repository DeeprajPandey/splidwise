...
# >     cli peer chaincode install -n splidwise -l node -v 1.0 -p /opt/gopath/src/github.com/splidwise
# 
# docker exec -e "CORE_PEER_TLS_ENABLED=true" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/home/managedblockchain-tls-chain.pem" \
    # -e "CORE_PEER_LOCALMSPID=$MSP" -e "CORE_PEER_MSPCONFIGPATH=$MSP_PATH" -e "CORE_PEER_ADDRESS=$PEER"  \
    # cli peer chaincode instantiate -o $ORDERER -C mychannel -n splidwise -v 1.0 -c '{"Args":[]}' --cafile /opt/home/managedblockchain-tls-chain.pem --tl
